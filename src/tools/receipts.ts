...
export async function handleGetToken(params: z.infer<typeof getTokenSchema>): Promise<string> {
  ...
  if (!response.ok) throw new Error(`ATOL getToken HTTP ${response.status}`);
...
export async function handleCreateSellReceipt(params: z.infer<typeof createSellReceiptSchema>): Promise<string> {
  const body = {
...
export async function handleCreateSellRefund(params: z.infer<typeof createSellRefundSchema>): Promise<string> {
  const body = {
    external_id: params.external_id,
    receipt: {
      client: {},
...
export async function handleCreateCorrection(params: z.infer<typeof createCorrectionSchema>): Promise<string> {
  const body = {
...
export async function handleCreateBuyReceipt(params: z.infer<typeof createBuyReceiptSchema>): Promise<string> {
  const body = {
    external_id: params.external_id,
    receipt: {
      client: {},
...
export async function handleCreateBuyRefund(params: z.infer<typeof createBuyRefundSchema>): Promise<string> {
  const body = {
    external_id: params.external_id,
    receipt: {
      client: {},
...
export async function handleGetTokenInfo(): Promise<string> {
